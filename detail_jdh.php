...
if ($id) {
    ...
    $apiUrl = 'http://143.198.218.9:8000/api/jdh/' . $id;
            ...
            <div class="col-md-8">
                <div class="card" style="background-color: #010314;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="http://143.198.218.9:8000/storage/jdh/<?php echo htmlspecialchars($data['lampiran']); ?>" class="btn-download" download>Download</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="preview-file">
                    <h5>Preview File</h5>
                    <embed class="pdf" src="http://143.198.218.9:8000/storage/jdh/<?php echo htmlspecialchars($data['lampiran']); ?>" width="800" height="500">
